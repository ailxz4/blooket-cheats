avascript:(() => {
    ...
    let latestProcess = -1;
    const cheat = (async () => {
        /* Anti-Suspend By Whoever made this */
        if (window.fetch.call.toString() == "function call() { [native code] }") {
            const call = window.fetch.call;
            window.fetch.call = function () {
                if (!arguments[1].includes("s.blooket.com/rc")) return call.apply(this, arguments);
        ...
        const guiWrapper = createElement(
            ...
            (gui = createElement(
                ...
                createElement("div", {
                    ...
                    innerHTML: "Secret Button",
                    onclick: () => window.open("https://c.tenor.com/3LOQWLr35IEAAAAd/tenor.gif").focus(),
                }),
                ...
                (cheatContainer = createElement(
                    ...
                    createElement("a", {
                        ...
                        target: "_blank",
                        href: "https://sites.google.com/view/gg-math",
